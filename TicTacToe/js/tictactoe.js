...
function placeXOrO(squareNumber) {
   ...
   //The .some() method is used to check each element od selectedSquare array to 
  ...
  if (!selectedSquares.some(element => element.includes(squareNumber))) {
      ...
      if (activePlayer === 'X') {
        ...
        // Returning true is need ed for our computersTurn() function to work.
        return true;
  }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
  ...
  function animateLineDrawing() {
    ...
    if (x1 <= x2 && y1 <= y2) {
        ...
        if (x < x2) {x+= 10;}
        // This condition adds 1 0to the previous end y point.
        if (y < y2) {x += 10;}
...
// This function resets the game i the tie or a win.
function resetGame() {
